...
| 4 Generate wait UX | In progress | 1536-token budget, Stop, honest wait copy, Generate again |
| 5 Workbook intelligence | Planned | Folder pack, schema, stored formulas, external-link graph |
| 6 Hidden interpreter | Planned | Restricted execution of generated Pandas; users never see Python |
| 7 Export | Planned | Cleaner `.xlsx` / `.csv` download |
| 8 Portable package | Planned | `LocalGridMind.exe` + sibling `models/` (not a 9 GB single exe) |
